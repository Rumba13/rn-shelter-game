    ...
    return (
        <View>
            <TouchableWithoutFeedback onPress={toggleModal}>
                <Image style={s.infoButtonIcon} resizeMode={"contain"}
            ...
            <OverlayModal isModalOpened={isModalOpened} setIsModalOpened={setIsModalOpened}>
                <View style={s.modalContent}>
                    ...
                    >
                        <ImageButton buttonImage={require("../../../../../assets/images/popup/close.png")}
                                     shadowImage={require("../../../../../assets/images/popup/close_shadow.png")}
                                     height={40} width={40} onPress={() => setIsModalOpened(false)}
                                     style={s.closeButton}/>
